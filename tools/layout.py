...
LINES = [
    ...
    row(185, 'Languages.Programming', 'Python, TypeScript, Dart, C++'),
    row(205, 'Languages.Computer', 'HTML, CSS, JSON, YAML, LaTeX'),
    row(225, 'Languages.Real', 'English, Hindi, Bengali'),
    row(255, 'Hobbies.Software', 'App Dev, Machine Learning, Generative AI'),
    row(275, 'Hobbies.Gaming', 'Valorant, BGMI, Black Myth: Wukong'),
    rule(305, '- Contact'),
